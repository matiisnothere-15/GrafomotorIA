            ...
            {planesFiltrados.map((p, i) => (
              <tr key={i}>
                ...
                <td className="acciones">
                  <button className="btn-icono" title="Ver Plan" onClick={() => verPlan(p.id_plan)}>👁️</button>
        ...
        {mostrarModal && (
          <div className="modal">
            <div className="modal-contenido">
              ...
              <div className="campo"><label>Nombre del paciente</label><input name="nombre_paciente" value={nuevoPlan.nombre_paciente} onChange={handleChange} readOnly={modoLectura} /></div>
              ...
              <div className="campo"><label>Edad</label><input name="edad" type="number" value={nuevoPlan.edad} onChange={handleChange} readOnly={modoLectura} /></div>
              <div className="campo"><label>RUT</label><input name="rut" value={nuevoPlan.rut} onChange={handleChange} readOnly={modoLectura} /></div>
              <div className="campo"><label>Patología</label><input name="patologia" value={nuevoPlan.patologia} onChange={handleChange} readOnly={modoLectura} /></div>
              <div className="campo"><label>Fecha inicio</label><input name="fecha_inicio" type="date" value={nuevoPlan.fecha_inicio} onChange={handleChange} readOnly={modoLectura} /></div>
